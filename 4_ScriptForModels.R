#Script just for loading the model
#without plots and trials
#then run "3_ScriptForANOVAs.R" for other stats
...
library(reshape)
#
#This is script for file "2_helperFUNfinal.R"
#Run it
...
#End of "2_helperFUNfinal.R" script

#Really don't know why I have to do above and these 2 below
...
#choose file TangoLyricsData.csv
...
#Already checked this fitted model in other script, so just setting up here.
